...
public interface ModelPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int ACC_TRACE_MODEL__REQUIREMENT_REPOSITORIES = 1;
	 ...
	 * @ordered
	 */
	int ACC_TRACE_MODEL__FILTER_TYPE = 2;
	...
	/**
	 * The meta object id for the '
	 * {@link br.ufms.facom.acctrace.model.impl.RequirementRepositoryImpl
	 * <em>Requirement Repository</em>}' class. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see br.ufms.facom.acctrace.model.impl.RequirementRepositoryImpl
	 * @see br.ufms.facom.acctrace.model.impl.ModelPackageImpl#getRequirementRepository()
	 * @generated
	 */
	int REQUIREMENT_REPOSITORY = 5;
	 ...
	 * @ordered
	 */
	int REQUIREMENT_REPOSITORY__NAME = RequirementPackage.REPOSITORY__NAME;

	/**
	 * The feature id for the '<em><b>Main Categories</b></em>' containment
	 * reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	int REQUIREMENT_REPOSITORY__MAIN_CATEGORIES = RequirementPackage.REPOSITORY__MAIN_CATEGORIES;
	 ...
	 * @ordered
	 */
	int REQUIREMENT_REPOSITORY__REFERENCED_OBJECT = RequirementPackage.REPOSITORY__REFERENCED_OBJECT;
	 ...
	 * @ordered
	 */
	int REQUIREMENT_REPOSITORY__ID = RequirementPackage.REPOSITORY_FEATURE_COUNT + 0;

	/**
	 * The number of structural features of the '<em>Requirement Repository</em>
	 * ' class. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	int REQUIREMENT_REPOSITORY_FEATURE_COUNT = RequirementPackage.REPOSITORY_FEATURE_COUNT + 1;
	 ...
	 * <em>Requirement Repository</em>}'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @return the meta object for class '<em>Requirement Repository</em>'.
	 * @see br.ufms.facom.acctrace.model.RequirementRepository
	 * @generated
	 */
	EClass getRequirementRepository();

	/**
	 * Returns the meta object for the attribute '
	 * {@link br.ufms.facom.acctrace.model.RequirementRepository#getId
	 * <em>Id</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for the attribute '<em>Id</em>'.
	 * @see br.ufms.facom.acctrace.model.RequirementRepository#getId()
	 * @see #getRequirementRepository()
	 * @generated
	 */
	EAttribute getRequirementRepository_Id();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '
		 * <em><b>Requirement Repositories</b></em>' containment reference list
		 * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		 ...
		 * @generated
		 */
		EClass REQUIREMENT_REPOSITORY = eINSTANCE.getRequirementRepository();
		 ...
		 * @generated
		 */
		EAttribute REQUIREMENT_REPOSITORY__ID = eINSTANCE
				.getRequirementRepository_Id();
