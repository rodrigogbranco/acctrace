 ...
 * 
 */
public class CopyOfAddOWLDialog_OLD extends Dialog {
	 ...
	 * @param parentShell
	 */
	public CopyOfAddOWLDialog_OLD(Shell parentShell) {
		super(parentShell);
	 ...
	 * @param parentShell
	 */
	public CopyOfAddOWLDialog_OLD(IShellProvider parentShell) {
		super(parentShell);
	}
